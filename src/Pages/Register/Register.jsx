...
const Register = () => {
  ...
  const {  user,
    ...
    return (
      ...
      <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl  mt-36 mb-10 '>
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://i.postimg.cc/c46z5r2q/giphy-2.gif')`,
          }}
        ></div>
      </div>
    </div>
